...
INSERT INTO ncaaresults VALUES
    ...
    (2016,6,1,'Championship',2,77,'Villanova','North Carolina',74,1),
    ...
    (2018,1,1,'South',1,54,'Virginia','UMBC',74,16),
    (2018,1,1,'South',2,68,'Cincinnati','Georgia St',53,15),
    (2018,1,1,'South',3,73,'Tennessee','Wright St',47,14),
    (2018,1,1,'South',4,68,'Arizona','Buffalo',89,13),
    (2018,1,1,'South',5,78,'Kentucky','Davidson',73,12),
    (2018,1,1,'South',6,62,'Miami','Loyola Chicago',64,11),
    (2018,1,1,'South',7,87,'Nevada','Texas',83,10),
    (2018,1,1,'South',8,59,'Creighton','Kansas St',69,9),
    (2018,1,2,'West',1,102,'Xavier','Texas Southern',83,16),
    (2018,1,2,'West',2,84,'North Carolina','Lipscomb',66,15),
    (2018,1,2,'West',3,61,'Michigan','Montana',47,14),
    (2018,1,2,'West',4,68,'Gonzaga','UNC Greensboro',64,13),
    (2018,1,2,'West',5,81,'Ohio St','South Dakota St',73,12),
    (2018,1,2,'West',6,67,'Houston','San Diego St',65,11),
    (2018,1,2,'West',7,73,'Texas A&M','Providence',69,10),
    (2018,1,2,'West',8,54,'Missouri','Florida St',67,9),
    (2018,1,3,'East',1,87,'Villanova','Radford',61,16),
    (2018,1,3,'East',2,74,'Purdue','Cal St Fullerton',48,15),
    (2018,1,3,'East',3,70,'Texas Tech','Stephen F Austin',60,14),
    (2018,1,3,'East',4,75,'Wichita St','Marshall',81,13),
    (2018,1,3,'East',5,85,'West Virginia','Murray St',68,12),
    (2018,1,3,'East',6,77,'Florida','St Bonaventure',62,11),
    (2018,1,3,'East',7,62,'Arkansas','Butler',79,10),
    (2018,1,3,'East',8,83,'Virginia Tech','Alabama',86,9),
    (2018,1,4,'Midwest',1,76,'Kansas','Pennsylvania',60,16),
    (2018,1,4,'Midwest',2,89,'Duke','Iona',67,15),
    (2018,1,4,'Midwest',3,82,'Michigan St','Bucknell',78,14),
    (2018,1,4,'Midwest',4,62,'Auburn','College of Charleston',58,13),
    (2018,1,4,'Midwest',5,79,'Clemson','New Mexico St',68,12),
    (2018,1,4,'Midwest',6,52,'TCU','Syracuse',57,11),
    (2018,1,4,'Midwest',7,83,'Rhode Island','Oklahoma',78,10),
    (2018,1,4,'Midwest',8,94,'Seton Hall','NC State',83,9),
    (2018,2,1,'South',16,43,'UMBC','Kansas St',50,9),
    (2018,2,1,'South',2,73,'Cincinnati','Nevada',75,7),
    (2018,2,1,'South',3,62,'Tennessee','Loyola Chicago',63,11),
    (2018,2,1,'South',13,75,'Buffalo','Kentucky',95,5),
    (2018,2,2,'West',1,70,'Xavier','Florida St',75,9),
    (2018,2,2,'West',2,65,'North Carolina','Texas A&M',86,7),
    (2018,2,2,'West',3,64,'Michigan','Houston',63,6),
    (2018,2,2,'West',4,90,'Gonzaga','Ohio St',84,5),
    (2018,2,3,'East',1,81,'Villanova','Alabama',58,9),
    (2018,2,3,'East',2,76,'Purdue','Butler',73,10),
    (2018,2,3,'East',3,69,'Texas Tech','Florida',66,6),
    (2018,2,3,'East',13,71,'Marshall','West Virginia',94,5),
    (2018,2,4,'Midwest',1,83,'Kansas','Seton Hall',79,8),
    (2018,2,4,'Midwest',2,87,'Duke','Rhode Island',62,7),
    (2018,2,4,'Midwest',3,53,'Michigan St','Syracuse',55,11),
    (2018,2,4,'Midwest',4,53,'Auburn','Clemson',84,5),
    (2018,3,1,'South',9,61,'Kansas St','Kentucky',58,5),
    (2018,3,1,'South',7,68,'Nevada','Loyola Chicago',69,11),
    (2018,3,2,'West',9,75,'Florida St','Gonzaga',60,4),
    (2018,3,2,'West',7,72,'Texas A&M','Michigan',99,3),
    (2018,3,3,'East',1,90,'Villanova','West Virginia',78,5),
    (2018,3,3,'East',2,65,'Purdue','Texas Tech',78,3),
    (2018,3,4,'Midwest',1,80,'Kansas','Clemson',76,5),
    (2018,3,4,'Midwest',2,69,'Duke','Syracuse',65,11),
    (2018,4,1,'South',9,62,'Kansas St','Loyola Chicago',78,11),
    (2018,4,2,'West',9,54,'Florida St','Michigan',58,3),
    (2018,4,3,'East',1,71,'Villanova','Texas Tech',59,3),
    (2018,4,4,'Midwest',1,85,'Kansas','Duke',81,2),
    (2018,5,1,'Final Four',11,57,'Loyola Chicago','Michigan',69,3),
    (2018,5,2,'Final Four',1,95,'Villanova','Kansas',79,1),
    (2018,6,1,'Championship',3,62,'Michigan','Villanova',79,1),
    (2019,1,1,'East',1,85,'Duke','North Dakota St',62,16),
    (2019,1,1,'East',2,76,'Michigan St','Bradley',65,15),
    (2019,1,1,'East',3,79,'LSU','Yale',74,14),
    (2019,1,1,'East',4,66,'Virginia Tech','St Louis',52,13),
    (2019,1,1,'East',5,76,'Mississippi St','Liberty',80,12),
    (2019,1,1,'East',6,79,'Maryland','Belmont',77,11),
    (2019,1,1,'East',7,76,'Louisville','Minnesota',86,10),
    (2019,1,1,'East',8,58,'VCU','Central Florida',73,9),
    (2019,1,2,'West',1,87,'Gonzaga','Fairleigh Dickinson',49,16),
    (2019,1,2,'West',2,74,'Michigan','Montana',55,15),
    (2019,1,2,'West',3,72,'Texas Tech','Northern Kentucky',57,14),
    (2019,1,2,'West',4,76,'Florida St','Vermont',69,13),
    (2019,1,2,'West',5,64,'Marquette','Murray St',83,12),
    (2019,1,2,'West',6,91,'Buffalo','Arizona St',74,11),
    (2019,1,2,'West',7,61,'Nevada','Florida',70,10),
    (2019,1,2,'West',8,69,'Syracuse','Baylor',78,9),
    (2019,1,3,'South',1,71,'Virginia','Gardner Webb',56,16),
    (2019,1,3,'South',2,77,'Tennessee','Colgate',70,15),
    (2019,1,3,'South',3,61,'Purdue','Old Dominion',48,14),
    (2019,1,3,'South',4,64,'Kansas St','UC Irvine',70,13),
    (2019,1,3,'South',5,54,'Wisconsin','Oregon',72,12),
    (2019,1,3,'South',6,61,'Villanova','St Marys',57,11),
    (2019,1,3,'South',7,72,'Cincinnati','Iowa',79,10),
    (2019,1,3,'South',8,72,'Ole Miss','Oklahoma',95,9),
    (2019,1,4,'Midwest',1,88,'North Carolina','Iona',73,16),
    (2019,1,4,'Midwest',2,79,'Kentucky','Abilene Christian',44,15),
    (2019,1,4,'Midwest',3,84,'Houston','Georgia St',55,14),
    (2019,1,4,'Midwest',4,87,'Kansas','Northeastern',53,13),
    (2019,1,4,'Midwest',5,78,'Auburn','New Mexico St',77,12),
    (2019,1,4,'Midwest',6,59,'Iowa St','Ohio St',62,11),
    (2019,1,4,'Midwest',7,84,'Wofford','Seton Hall',68,10),
    (2019,1,4,'Midwest',8,61,'Utah St','Washington',78,9),
    (2019,2,1,'South',1,77,'Duke','Central Florida',76,9),
    (2019,2,1,'South',2,70,'Michigan St','Minnesota',50,10),
    (2019,2,1,'South',3,69,'LSU','Maryland',67,6),
    (2019,2,1,'South',4,67,'Virginia Tech','Liberty',58,12),
    (2019,2,2,'West',1,83,'Gonzaga','Baylor',71,9),
    (2019,2,2,'West',2,64,'Michigan','Florida',49,10),
    (2019,2,2,'West',3,78,'Texas Tech','Buffalo',58,6),
    (2019,2,2,'West',4,90,'Florida St','Murray St',62,12),
    (2019,2,3,'East',1,63,'Virginia','Oklahoma',51,9),
    (2019,2,3,'East',2,83,'Tennessee','Iowa',77,10),
    (2019,2,3,'East',3,87,'Purdue','Villanova',61,6),
    (2019,2,3,'East',13,54,'UC Irvine','Oregon',73,12),
    (2019,2,4,'Midwest',1,81,'North Carolina','Washington',59,9),
    (2019,2,4,'Midwest',2,62,'Kentucky','Wofford',56,7),
    (2019,2,4,'Midwest',3,74,'Houston','Ohio St',59,11),
    (2019,2,4,'Midwest',4,75,'Kansas','Auburn',89,5),
    (2019,3,1,'South',1,75,'Duke','Virginia Tech',73,4),
    (2019,3,1,'South',2,80,'Michigan St','LSU',63,3),
    (2019,3,2,'West',1,72,'Gonzaga','Florida St',58,4),
    (2019,3,2,'West',2,44,'Michigan','Texas Tech',63,3),
    (2019,3,3,'East',1,53,'Virginia','Oregon',49,12),
    (2019,3,3,'East',2,94,'Tennessee','Purdue',99,3),
    (2019,3,4,'Midwest',1,80,'North Carolina','Auburn',97,5),
    (2019,3,4,'Midwest',2,62,'Kentucky','Houston',58,3),
    (2019,4,1,'South',1,67,'Duke','Michigan St',68,2),
    (2019,4,2,'West',1,69,'Gonzaga','Texas Tech',75,3),
    (2019,4,3,'East',1,80,'Virginia','Purdue',75,3),
    (2019,4,4,'Midwest',5,77,'Auburn','Kentucky',71,2),
    (2019,5,1,'Final Four',2,51,'Michigan St','Texas Tech',61,3),
    (2019,5,2,'Final Four',1,63,'Virginia','Auburn',62,5),
    (2019,6,1,'Championship',3,77,'Texas Tech','Virginia',85,1);
